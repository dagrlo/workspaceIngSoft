...
import es.uv.isw.app3.beans.MailingBean;
import es.uv.isw.app3.beans.MailingBeanFactory;
...
public class ListController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String nextPage = "/WEB-INF/private/success.jsp";
		if (!result) nextPage = "/WEB-INF/private/failure.jsp";
